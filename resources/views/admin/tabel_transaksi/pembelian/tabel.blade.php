...
<div class="content">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb p-0">
            ...
            <li class="breadcrumb-item" aria-current="page">Tabel Pembelian Barang</li>
        </ol>
    </nav>

    <a href="{{ '/pembelian/input' }}" type="button" class="mb-1 btn btn-primary mt-5 text-white">
        ...
        <div class="col-12">
            ...
            <div class="card card-default">
                <div class="card-header card-header-border-bottom justify-content-between">
                    <h2>Table Pembelian Barang</h2>

                    <form action="{{ '/pembelian/getFilter' }}" method="POST">
                        @csrf
                        ...
                        <table id="basic-data-table" class="table nowrap example" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-dark"><b>{{ $item->nama_toko }}</b></td>
                                    <td class="text-dark"><b>{{ $item->tanggal_beli }}</b></td>
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        swal("Poof! Your imaginary file has been deleted!", {
                            ...
                            window.location.href = "pembelian/" + id + "/delete"
                        })
                    } else {
